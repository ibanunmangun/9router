...
| S7 | Independent review, full gates, build, DEV delivery | S1–S4 independent review complete; build + DEV delivery done for S4 snapshot; S6 runbook update and consolidated full-suite/UI-suite S7 pass still outstanding | S1–S6 |
